...
{
    public partial class PopUp_Cancel : Form
    {
        private OrderResponse _order;
        private IParentView _parentView;
        public PopUp_Cancel(IParentView parentView, OrderResponse order)
        {
        ...
        private List<ReasonTypeResponse> selectReasonCancel;
